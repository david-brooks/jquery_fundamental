...
//  	var children = $('#target').children('.child');
...
// Hint: you can use .animate, .width, and .height
 ...
 // $(document).ready(function(){
 // $('#target').animate({height: "300px", width: "200px"}, 5000)
 // 	 })
...
// Hint: you can select the option and use .filter and .css
 ...
 // 	$('#target select option' ).filter( ":even" ).css( "background-color", "red" );
 //  });
...
// $(document).ready( function() {
//    var boxes = $('.target');
//    boxes.not(boxes.children().parent()).remove();
//  });
